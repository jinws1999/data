...
import tokenization
import modeling
from run_classifier_sp_google import InputFeatures, InputExample, DataProcessor, create_model, convert_examples_to_features
...
if __name__ == '__main__':
    sim = BertSim()
    sim.start_model()
    sim.predict_sentences([("我喜欢妈妈做的汤", "妈妈做的茶我很不喜欢喝")])
